...
class SinogramDataset(Dataset):
    def __init__(self, ifn, params, world_size=None, rank=None):
        ...
        if ds_cfg['norm']:
            #print(ds_cfg.get('mean4norm'))
            # if ds_cfg.get('mean4norm') == None:
            if ds_cfg.get('dkey') == 'field':
                # print("NONE!")
                # print("m")
        ...
        # print(self.len,self.seqlen,self.cdim,self.shape) 7200,256,512,(7200, 256, 512)
        # print("end")
